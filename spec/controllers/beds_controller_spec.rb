...
RSpec.describe BedsController, type: :controller do
  ...
  describe "GET #new" do
    it "assigns a new bed as @bed" do
      ...
      expect(assigns(:bed)).to be_a_new(Bed)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created bed as @bed" do
        post :create, params: {bed: valid_attributes}, session: valid_session
        expect(assigns(:bed)).to be_a(Bed)
        expect(assigns(:bed)).to be_persisted
      end

      it "redirects to the created bed" do
        post :create, params: {bed: valid_attributes}, session: valid_session
        expect(response).to redirect_to(Bed.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the bed" do
        bed = Bed.create! valid_attributes
        put :update, params: {id: bed.to_param, bed: valid_attributes}, session: valid_session
        expect(response).to redirect_to(bed)
      end
    end
